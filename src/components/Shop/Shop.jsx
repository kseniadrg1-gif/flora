    ...
    <>
      <div className="page">
        <header className="topbar">
          <nav>
            <button className="nav-btn" onClick={scrollToProducts}>
              каталог
            </button>
            <button className="nav-btn" onClick={scrollToCare}>
              уход
            </button>
        ...
        <section className="hero">
          ...
          <button className="select-plant-btn" onClick={scrollToProducts}>
            Выбрать растение
          </button>
          ...
          <div className="why-grid">
            ...
            <div>
              ...
              <p>
                ...
                кислород. Некоторые виды могут уменьшать уровень стресса,
                повышать настроение
              </p>
            </div>
        ...
        <section ref={careRef} className="care">
